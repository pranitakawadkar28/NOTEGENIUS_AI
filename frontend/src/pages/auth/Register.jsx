...
import { User, Mail, Lock, ArrowRight, Eye, EyeOff, BrainCircuit } from 'lucide-react'
    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg-primary)] px-4 py-12">
      <div className="w-full max-w-md space-y-8 animate-fade-in">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-[var(--text-primary)]">Create account</h2>
        ...
        <div className="glass rounded-3xl p-8 shadow-xl border border-[var(--border-primary)] space-y-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="username">Username</Label>
              <div className="relative">
                <User className="absolute left-3 top-3 h-4 w-4 text-[var(--text-secondary)]" />
                <Input id="username" placeholder="johndoe_123" className="pl-10 h-11" {...register('username')} />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-3 h-4 w-4 text-[var(--text-secondary)]" />
                <Input id="email" placeholder="name@example.com" className="pl-10 h-11" {...register('email')} />
              </div>
          ...
          <Button 
            ...
            className="w-full bg-[var(--bg-secondary)] border-[var(--border-primary)] text-[var(--text-primary)] hover:bg-[var(--bg-secondary)]/80 h-11"
          >
