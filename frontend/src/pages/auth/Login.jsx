...
import { Eye, EyeOff, Mail, Lock, ArrowRight, BrainCircuit } from 'lucide-react'
    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg-primary)] px-4 py-12">
      <div className="w-full max-w-md space-y-8 animate-fade-in">
        ...
        <div className="glass rounded-3xl p-8 shadow-xl border border-[var(--border-primary)] space-y-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" core="forgot-password-link" className="text-xs text-brand-500 hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          {/* Standardized Divider & Google Button at Bottom */}
